...
var VanillaModal = unwrapExports(dist);
...
var StaticHeaderReduced = function () {
  function StaticHeaderReduced(section) {
    classCallCheck(this, StaticHeaderReduced);

    this.section = section;
    this.modal = null;
    this.passwordTrigger = section.el.querySelector(selectors.password.trigger);

    if (this.passwordTrigger) {
      this._initPassword();
    }
  }

  createClass(StaticHeaderReduced, [{
    key: 'onSectionUnload',
    value: function onSectionUnload() {
      ...
      if (this.passwordTrigger) {
        this.passwordTrigger.removeEventListener('click', this.onPasswordTrigger);
      }
    }
  }, {
    key: '_initPassword',
    value: function _initPassword() {
      this.onModalClose = this._onModalClose.bind(this);
      this.onModalOpen = this._onModalOpen.bind(this);
      this.onPasswordTrigger = this._toggleModal.bind(this);
      this.passwordTrigger.addEventListener('click', this.onPasswordTrigger);
      ...
      if (this.section.el.querySelector(selectors.password.errors)) {
        this._toggleModal();
      }
    }
  }, {
    ...
    value: function _toggleModal() {
      if (this.modal.isOpen()) {
        ...
        this.modal.open(selectors.password.modal, 'password');
      }
    }
  }, {
    key: '_onModalClose',
    value: function _onModalClose() {
      jquery$1(this.passwordTrigger).focus();
    }
  }, {
    key: '_onModalOpen',
    value: function _onModalOpen($modal) {
      $modal.find('.form-element.input').focus();
    }
  }]);
  return StaticHeaderReduced;
}();
...
sections.register('static-header-reduced', function (section) {
  return new StaticHeaderReduced(section);
});
...
//# sourceMappingURL=reduced.js.map?1531381323292
